...
- [x] 1.1 Add context snapshot types for semantic hierarchy and execution substrate.
...
- [x] 1.2 Implement context snapshot assembly from persisted Jcode identity, current session/client state, path-derived fallback, and optional Herdr metadata.
...
- [x] 1.3 Persist additive semantic context identity across reload and reconnect.
...
- [x] 2.1 Add Control Room overlay state, renderer, and deterministic rendering fixtures.
...
- [x] 2.2 Wire `Alt+O` toggle and overlay input ownership.
...
- [x] 2.3 Implement overlay navigation, copy action, safe focus action, and feedback.
...
- [x] 3.1 Add context architecture documentation.
...
- [x] 3.2 Add integration and test evidence documentation.
...
- [x] 3.3 Run focused app-core context/session validation.
...
- [x] 3.4 Run focused TUI overlay/keybinding validation.
...
- [x] 3.5 Run final repository feature validation and persistence.
