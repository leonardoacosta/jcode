...
- [ ] 1.1 Add explicit Brown scene subnet geometry metadata sourced from the validated Network sidecar, including VNet/subnet IDs, labels, CIDRs, and node memberships.
...
- [ ] 2.1 Render labeled isometric VNet terrain and nested subnet planes in the dark theme.
...
- [ ] 2.3 Preserve full resource labels, Azure icons, path semantics, runtime emphasis, and no aggregate incoming-traffic arrow.
...
- [ ] 3.2 Regenerate `docs/diagrams/isometric-canvas-dark.html` from the validated Brown scene.
