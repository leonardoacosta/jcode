...
- [x] 1.1 Add `display.composer` config section with style and metadata toggle.
...
- [x] 1.2 Add composer frame color keys resolving through the existing color map.
...
- [x] 2.1 Implement accent rail rendering with mode colors and capability fallbacks.
...
- [x] 2.2 Implement the composer metadata row with fixed format and degradation order.
...
- [x] 3.1 Integrate rail inset and metadata height into composer layout math.
...
- [x] 3.2 Extend copy-selection margins to the rail and exclude the metadata row.
...
- [x] 4.1 Add deterministic composer frame snapshot suite.
