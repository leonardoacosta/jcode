...
Standard templates for creating consistent, comprehensive test cases. Which template to reach for,
and what priority/tag to assign, is governed by this skill's [SKILL.md](../SKILL.md) §
"Escalation Judgment" (severity/reproducibility/automation-cost axes) and § "Tag-Gate Interaction"
(naming the `t3-testing-patterns` tag at plan time, not after the fact).
