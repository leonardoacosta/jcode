...
> stay-on-dotenv-cli verdict is reversed.
...
- **Audit** — worth scripting a check that reports a repo's script placement classes, root-key
  coverage, and turbo awareness; the classes above are the rubric.
