...
real raster asset that CSS/SVG can't produce, generate it with whatever image-generation tool
your setup provides and match the prompt to your chosen palette
...
**How to load:** load the `motion-and-transitions` skill.
...
Wrap the shader HTML in a small React/Next.js component in the target project, e.g.
`<RadiantShader html={...} colorScheme="blue" loading="lazy" />`.
