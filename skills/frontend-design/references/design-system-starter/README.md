...
> Formerly a standalone skill (`design-system-starter`), demoted to a `frontend-design`
> reference (`skill-classification-and-trial-lifecycle`, 2026-07-18) — restates atomic-design/
> WCAG/dark-mode basics with minimal house-specific delta. Original vendored source:
> `~/.agents/skills@2026-07-13` (MIT). Create and evolve design systems with design tokens,
> component architecture, accessibility guidelines, and documentation templates. See sibling
> `checklists/` and `templates/` in this directory.
