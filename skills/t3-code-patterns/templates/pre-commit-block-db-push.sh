...
# (the a prior migration incident incident, 2026-06-20).
#
...
# closed task text. Recurred twice during a production migration follow-up —
...
if [ -n "$violations" ]; then
  ...
  echo "(a prior migration incident, 2026-06-20). See t3-code-patterns skill, Migrations section." >&2
  echo "" >&2
