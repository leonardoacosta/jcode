...
If a real match exists, load it directly through your harness's skill-loading verb — rather than
...
npx skills add <owner/repo@skill> -a <your-harness> -y   # install — ALWAYS pass -a; omitting it sprawls .agents/.crush/.goose dirs
```

After install, reload skills if your harness supports it; otherwise a freshly-installed skill
stays invisible until you restart the session.
