...
> Note: Standard Readme is designed for open source libraries. Although it was historically made
> for Node and npm projects, it also applies to libraries in other languages and package managers.
