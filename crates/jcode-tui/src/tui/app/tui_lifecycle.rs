...
impl App {
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            artifact_action_palette: None,
            active_herald_request_id: None,
            ...
            footer_config: display.footer.clone(),
            composer_config: display.composer.clone(),
            user_messages_config: display.user_messages.clone(),
