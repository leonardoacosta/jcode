...
include!("tests/completion_review_telemetry.rs");
...
include!("tests/user_message_frame_copy.rs");
...
include!("tests/control_room.rs");
include!("tests/artifact_action_command.rs");
#[test]
